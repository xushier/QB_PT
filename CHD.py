...
hr_re_rule   = r'<b>H&R:&nbsp;<\/b>(.*)<\/td>'

free_torrents = Get_Free(cookie, rss_url, run_log).get_free_torrents(temp_log, category, min_size=min_size, max_size=max_size, free_re_rule=free_re_rule, hr_re_rule=hr_re_rule)
qb = Client()
