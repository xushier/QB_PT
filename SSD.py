...
cron: 0 0/3 * * *
任务名称
new Env('获取 SpringSunday 指定种子');

变量
export springsunday_cookie=""
export springsunday_rssurl=""
export springsunday_limit=""  # 格式:最小-最大-上传速度 例: 15-800-50,即过滤 15GB 到 800GB 的免费非 HR 非老种,且添加到 QB 时设置上传限速为 50 MB/S
'''
